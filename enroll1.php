                ...
                <div class="panel-body">
                  <form name="dept" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="studentname" name="studentname" value="<?php echo htmlentities($_SESSION['sname']); ?>" readonly />
                    </div>

                    <div class="form-group">
                      <label for="studentregno">Student Reg No </label>
                      <input type="text" class="form-control" id="studentregno" name="studentregno" value="<?php echo htmlentities($_SESSION['login']); ?>" placeholder="Student Reg no" readonly />

                    </div>

                    <div class="form-group">
                      <label for="batch">Batch </label>
                      <input type="text" class="form-control" id="batch" name="batch" readonly value="<?php echo htmlentities($_SESSION['batch']); ?>" required />
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <?php if ($row['studentPhoto'] == "") { ?>
                        <img src="studentphoto/noimage.png" width="200" height="200"><?php } else { ?>
                          <img src="data:image/jpeg;base64,<?php echo $_SESSION['photo']; ?>" width="200" height="200">
                      <?php } ?>
                    </div>
                  <?php } ?>
              ...
              <font color="green" align="center"><?php  echo htmlentities($_SESSION['msg']);  echo htmlentities($_SESSION['msg']="");?></font>
                  <div class="panel-body">
                    <form action="enroll.php" method="post">
                                ...
                                <button type="submit" name="sendreq" id="sendreq" class="btn btn-default">send request</button>
                                                <hr />
